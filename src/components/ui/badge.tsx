...
const badgeVariants = cva(
  "rounded text-xs font-bold inline-flex items-center px-2.5 py-0.5 font-public-sans transition-colors focus:ring-2 focus:ring-blue-40 focus:ring-offset-2 focus:outline-none",
  {
    variants: {
      variant: {
