...
```json
{
  ...
  "registries": {
    "@ccdi-ui-components": "https://cbiit.github.io/ccdi-ui-components/ccdi-ui-components/r/{name}.json"
  }
}
```
...
```bash
npx shadcn@latest add hhttps://cbiit.github.io/ccdi-ui-components/r/button.json
