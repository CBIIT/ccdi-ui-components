...
Learn how to install and use CCDI components in Next.js or Vite projects. This guide covers the registry setup, required dependencies, and framework-specific style packs.
...
- Next.js 14+ or Vite 5+ project
- TypeScript
- Tailwind CSS

## 🚀 Quick Installation

Install components directly into your project using our shadcn-compatible registry.
...
Add the framework-specific USWDS base styles:
...
# Vite
npx shadcn@latest add https://cbiit.github.io/ccdi-ui-components/r/vite-styles.json
```

The Next.js style pack writes to `app/globals.css` and `app/theme.css`. The Vite style pack writes to `src/index.css` and `src/theme.css`.
