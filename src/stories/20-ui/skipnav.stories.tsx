...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A skip navigation link component that allows users to skip to the main content. Hidden by default and appears when focused, following USWDS accessibility guidelines.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: (args) => (
    <div className="relative w-full">
      ...
      <main id="main-content" className="p-8">
        <p className="mb-4">
          The skip navigation link allows keyboard users and screen reader users to bypass
          repetitive navigation and jump directly to the main content of the page. This improves
          accessibility and user experience.
        </p>
        <p className="mb-4">
          When you press Tab on this page, the skip link will appear at the top, allowing you to
          quickly navigate to this section without having to tab through all the navigation
          elements.
        </p>
        <p>
          This is especially helpful for users who rely on keyboard navigation or assistive
          technologies, as it saves time and reduces frustration when accessing the primary content
          of a webpage.
        </p>
      </main>
    </div>
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The skip navigation link follows WCAG 2.1 AA guidelines:\n" +
  ...
  render: (args) => (
    <div className="relative w-full">
      ...
      <section id="primary-content" className="p-8">
        ...
        <p className="mb-4">
          This example demonstrates how the skip navigation link can target different sections of a
          page. By customizing the href prop, you can point the skip link to any element with a
          matching ID.
        </p>
        <p className="mb-4">
