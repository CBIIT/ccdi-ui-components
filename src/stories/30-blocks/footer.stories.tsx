...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A USWDS-compliant footer component with navigation sections, newsletter signup, contact information, social links, and agency information. Features responsive design with mobile accordion navigation.",
      },
    },
  },
  tags: ["autodocs"],
